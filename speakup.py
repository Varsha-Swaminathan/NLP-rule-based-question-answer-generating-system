...
class Widget():
    def __init__(self):
        ...
        self.inputTextwid=Text(self.frame1,width=80,bg="#cce6ff",height=5, font='comicsansms 12') # sets the initial size
        ...
        self.outputTextwid=Text(self.frame2,bg="#cce6ff", height=5,font='comicsansms 12') # sets the initial size
